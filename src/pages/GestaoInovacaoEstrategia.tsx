  ...
  const loadMentors = async () => {
    try {
      ...
      const filteredMentors = mentorData.filter(mentor => 
        ...
        mentor.setor?.toLowerCase().includes('transformação digital') ||
        mentor.setor?.toLowerCase().includes('transformacao digital') ||
        mentor.setor?.toLowerCase().includes('agile') ||
        mentor.setor?.toLowerCase().includes('scrum') ||
        mentor.setor?.toLowerCase().includes('product management') ||
        mentor.setor?.toLowerCase().includes('gestão de produtos') ||
        mentor.setor?.toLowerCase().includes('gestao de produtos') ||
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 relative">
          ...
          <div className="text-center mt-8 sm:mt-12">
            <div className="bg-white/15 backdrop-blur-sm rounded-full p-3 sm:p-4 w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 border border-white/20">
              <BarChart3 className="w-10 h-10 sm:w-12 sm:h-12 text-white mx-auto" />
            </div>
            ...
            {allMentors.length > 0 ? (
              ...
              <div className="text-center py-12 sm:py-20">
                <div className="bg-gradient-to-br from-[#10CA7B]/10 to-[#11AE5E]/10 rounded-full w-24 h-24 sm:w-32 sm:h-32 flex items-center justify-center mx-auto mb-4 sm:mb-6">
                  <BarChart3 className="w-12 h-12 sm:w-16 sm:h-16 text-[#11AE5E]" />
                </div>
